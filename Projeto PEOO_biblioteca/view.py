...
class View:
    ...
    def emprestimo_inserir(id_Livro, idUsuario, reserva, data_emprestimo, data_devolucao, devolucao):
        data_emprestimo = datetime.now()
        data_devolucao = data_emprestimo + timedelta(days=7)

        u = Emprestimo(0, id_Livro, idUsuario, reserva, data_emprestimo, data_devolucao, devolucao)
    ...
    def emprestimo_atualizar(id, idLivro, idUsuario, reserva, data_emprestimo, data_devolucao, devolucao):
        ...
        u = Emprestimo(id, idLivro, idUsuario, reserva, data_emprestimo, data_devolucao, devolucao)
