...
class Usuario:
    def __init__(self, id, livro, autor, idGenero, editora, ano, quantidade, quantDisponivel):
        ...
        self.__quantDisponivel = quantDisponivel
    ...
    # str
    def __str__(self):
        print (f"Livro: {self.__livro} - {self.__autor} - {self.__idGenero} - {self.__editora} - {self.__ano} - {self.__quantidade} - {self.__quantDisponivel}")
...
class Livros(CRUD):
    def atualizar(self, obj):
        ...
        if g:
            ...
            g.quantDisponivel = obj.quantDisponivel
            self.salvar()
    ...
    def abrir(self):
        ...
        try:
                with open("livros.json", mode="r") as arquivo:   # r - read
                    ...
                    for obj in texto:   
                        g = Usuario(obj["__id"], obj["__livro"], obj["__autor"], obj["__idGenero"], obj["__editora"], obj["__ano"], obj["__quantidade"], obj["__quantDisponivel"])
