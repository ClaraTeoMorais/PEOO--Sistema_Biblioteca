...
class Manter_Livro_UI:
    ...
    def inserir():
        ...
        quantidade = st.number_input("Informe o quantidade de livros", step=1, min_value=0)
        quantDisponivel = st.number_input("Informe o quantidade de livros disponíveis", step=1, min_value=0)
