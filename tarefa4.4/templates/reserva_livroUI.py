...
# ESTÁ FILTRANDO APENAS OS QUE JÁ ESTÃO COM O EMPRÉSTIMO CONFIRMADO!!!!! AJEITAR
class Solicitacoes_emprestimo_UI:
    def main():
        st.header("Solicitações de reserva pendentes")
        Solicitacoes_emprestimo_UI.listar()
